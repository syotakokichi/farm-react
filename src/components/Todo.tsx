...
export const Todo:FC = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col min-h-screen tezt-gray-600 font-mono">
      <div className="flex items-center">
        <ShieldCheckIcon className="h-8 w-8 mr-2 text-blue-500 cursor-pointer" />
